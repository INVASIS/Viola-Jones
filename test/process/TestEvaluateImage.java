...
public class TestEvaluateImage {
    ...
    public void getAllRectanglesTest() {
        ArrayList<Rectangle> rectangles = getAllRectangles(19, 19, 1.25f, 1, 1, 19, 19);
        Assert.assertEquals(1, rectangles.size());

        rectangles = getAllRectangles(19, 18, 1.25f, 1, 1, 19, 19);
        Assert.assertEquals(0, rectangles.size());

        rectangles = getAllRectangles(19, 20, 1.25f, 1, 1, 19, 20);
        Assert.assertEquals(2, rectangles.size());

        rectangles = getAllRectangles(22, 22, 1.25f, 1, 1, 19, 22);
        Assert.assertEquals(16, rectangles.size());

        rectangles = getAllRectangles(23, 22, 1.25f, 1, 1, 19, 22);
        Assert.assertEquals(20, rectangles.size());

        rectangles = getAllRectangles(23, 23, 1.25f, 1, 1, 19, 23);
        Assert.assertEquals(26, rectangles.size());

        rectangles = getAllRectangles(23, 23, 1.30f, 1, 1, 19, 23);
