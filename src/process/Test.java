...
public class Test {
    ...
    public void evaluateImage(String img, ImageEvaluator imageEvaluator, boolean postProcess) {
    ...
    private void soutenance(int w, int h) {
        ...
        evaluateImage("data/land.jpg", evaluator100, true);
